...
curl -X POST https://api.resend.com/emails \
  ...
  -d '{
    "from": "AI Home Building <newsletter@aihomebuilding.com>",
    "to": "subscriber@example.com",
    "subject": "New from AI Home Building: [Article Title]",
    "html": "<h2>[Title]</h2><p>[First 2 paragraphs]</p><p><a href=\"https://rayhe.github.io/aihomebuilding/[slug].html\">Read the full article →</a></p><hr><p style=\"font-size:12px;color:#666;\"><a href=\"https://rayhe.github.io/aihomebuilding/unsubscribe.html?id=[sub-id]&site=aihomebuilding\">Unsubscribe</a></p>"
  }'
```
