...
## AI Evaluation Cap
**You are an AI. You CANNOT give any game a score above 88/100.**
- If a game deserves S-tier, score it 88/100 and note: "S-tier candidate — requires Ray's playtest"
- Do NOT round up to 90+ under any circumstances
- The old pattern of "add rank progression → 30/30 → S-tier" is dead. Rank progression helps Return Visits but doesn't improve Session Variance, Strategic Depth, Surprise, or Craft.
...
### 5. Polish A-tier games
Pick the A-tier game closest to 88. Make ONE refinement targeting the weakest dimension. But remember: you cannot promote above 88/100 no matter what.
