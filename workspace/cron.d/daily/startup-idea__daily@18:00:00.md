...
The idea should be specific and defensible — a real niche with a clear path to revenue. Not "AI for X" generic slop. Think: specific customer segment + specific pain point + specific business model + why existing solutions miss it.
