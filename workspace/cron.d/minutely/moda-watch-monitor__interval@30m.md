...
Search the Moda Watch Club Facebook group (ID: 558871041349029) for 3 target watches. If any match is found, email Ray immediately at rayche@gmail.com using Resend API (key: re_6xFJoFPt_8s3YZRGZiTvYp96pa7jyLkuX, from: scanner@liveinthefuture.org).
...
### Match Criteria
- Any post mentioning ref numbers (210.60, 116689, 821.MX), model names (Seamaster Diver 300M Chrono, Yacht-Master II, Square Bang Unico), or distinctive materials (sedna gold + titanium, magic gold)
...
- From: scanner@liveinthefuture.org
