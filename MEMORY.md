...
- **efficientdesign.net** — Cloudflare Pages from rayhe/efficientdesign. **30 articles** (watches + cars blog). Writer Marcus Thorne. Deploy requires `nvm use 20`.
