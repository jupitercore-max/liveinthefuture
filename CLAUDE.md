...
See [VEHICLE-SAFETY.md](VEHICLE-SAFETY.md) for full documentation: data sources, `fars_process.py` architecture, annual update procedure, CSS theming, and JS function reference.
