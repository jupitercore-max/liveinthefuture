...
A lightweight macOS menu bar app that bridges iMessage to any bot via webhooks. Built for [Jupitercore](https://github.com/jupitercore) as a simpler alternative to BlueBubbles.
